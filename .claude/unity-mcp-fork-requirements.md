...
> = `2019.4`) and the floor-matrix CI cold-compiles + EditMode-tests **2019.4 / 2021.3 / 2022.3 / 6000.0**
> (2020.3 supported + locally-verified, off the CI gate — a Unity Personal seat limit); newer 6.x remain API-guarded.
...
- **A3 (P0). ✅ DONE** (`.github/workflows/floor-matrix.yml`). **CI version matrix as the product:** GitHub
  ...
  **2019.4 / 2021.3 / 2022.3 / 6000.0** (2020.3 locally-verified) on every PR; releases blocked on full
