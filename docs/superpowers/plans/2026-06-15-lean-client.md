...
- [ ] **Stage 3** — manifest result-field advertisement (editor advertises result hints; list_unity_tools surfaces them). Editor-side → floor-dogfoodable.
- [ ] **Stage 4 / docs** — finalize: rewrite README "Available Tools" for the on-demand model (it still lists the pre-lean catalog); CHANGELOG 0.5.0.
